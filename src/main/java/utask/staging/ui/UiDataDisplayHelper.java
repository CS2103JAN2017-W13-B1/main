...
public class UiDataDisplayHelper {
    ...
    static {
        inputSuggestion.put("create", "create NAME [/by DEADLINE] [/from START_TIME to END_TIME] [/repeat FREQUENCY] [/tag TAG...]");
        inputSuggestion.put("update", "update INDEX [/name NAME] [/by DEADLINE] [/from START_TIME to END_TIME] [/repeat FREQUENCY] [/tag TAG...][/done YES|NO]");
